...
return [
    //HUF
    'HUF_MERCHANT' => env('SIMPLE_MERCHANT_HUF', ''),            //merchant account ID (HUF)
    'HUF_SECRET_KEY' => env('SIMPLE_SECRET_HUF', ''),          //secret key for account ID (HUF)

    //EUR
    'EUR_MERCHANT' => env('SIMPLE_MERCHANT_EUR', ''),            //merchant account ID (EUR)
    'EUR_SECRET_KEY' => env('SIMPLE_SECRET_EUR', ''),          //secret key for account ID (EUR)
    ...
    //common return URL
    'URL' => env('SIMPLE_BACK_REF', ''),//'http://' . $_SERVER['HTTP_HOST'] . '/payment/back',
    ...
    */
    ...
    'LOG_PATH' => storage_path('logs/simple'),                           //path of log file
